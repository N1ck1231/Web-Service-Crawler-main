...
export default {
  pageRecords(page, size, sortName) {
    return request({
      url: '/sampleSourceCode/selectByPage',
      method: 'get',
  ...
  getCategoriesCount(num) {
    return request({
      url: '/sampleSourceCode/groupQuery',
      method: 'get',
      params: { 'num': num}
    })
  },
  selectStaticApis(num) {
    return request({
      url: '/sampleSourceCode/selectStaticApis',
      method: 'get',
      params: { 'num': num}
    })
  },
  searchLikeName(name,value,page,size,sortName) {
    console.log("名称",name)
    return request({
      url: '/sampleSourceCode/searchLikeName',
      method: 'get',
  ...
  selectTag(num) {
    return request({
      url: '/sampleSourceCode/selectTag',
      method: 'get',
      params:{'num': num}
    })
  }
