...
public interface SdksService {
     ...
     * 根据page来查询记录
     */
    List<Sdks> selectByPage(int page,int size,String sortName);
    /**
     * 获取总记录条数
     * @return
     */
     ...
     * @return
     */
    List<Sdks> searchLikeName(String name,String value,int page,int size,String sortName);
    /**
