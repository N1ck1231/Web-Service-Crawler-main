...
public interface MashupsService {
    /**
     * 查询所有记录
     * @return
     */
    List<Mashups> selectAll();
    /**
     * 根据page来查询记录
     */
    List<Mashups> selectByPage(int page,int size,String sortName);
    /**
     * 获取总记录条数
     * @return
     */
     ...
     * @return
     */
    List<Mashups> searchLikeName(String name,String value,int page,int size,String sortName);
